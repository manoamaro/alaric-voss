...
It stood empty, as before. That detail ought not to have mattered, and yet in this country absence rarely means nothing. The rope stirred faintly, despite still air. I observed no wind, no tremor in the post, no visible cause. Only motion without origin.

Then the dead appeared.

Not corpses—impressions. Figures drawn out of the earth itself, shaped like men and women who had once walked this road. Armed. Silent. Purposeful. Each one moved in the same direction.
...
I observed the structure rather than the mysticism. Each position corresponded to a function, and each function carried its own weight of inference.
...
Its location was defined by contradiction: wolves, hills, a lake, and the name of Mother Night. Protective artefacts do not naturally reside within predatory domains. The conclusion presents itself:
...
A request followed the reading.

A child—Arabelle. A birthday in seven days. A toy.

Payment was offered in advance, which is itself a piece of information about the request. Favours establish obligation, and obligation creates structure. Even trivial exchanges generate alignment, and in a country where alignment is one of the few currencies that still functions, no offered favour is incidental.
...
The encampment was gone. The trees behind us were inert. The environment had reset without trace of origin.

We talked, briefly. I disclosed the prior vision of the castle's heart. Reactions varied. All rational. None actionable.
...
That, more than anything I saw today, is what I intend to avoid.
