...
Damage: 5d10
"Damage Type": Psychic
Upgrade: "Using a Higher-Level Spell Slot. If you use a level 7 or 8 spell slot, the duration is 365 days. If you use a level 9 spell slot, the spell lasts until it is ended by one of the spells mentioned above."
Spell Book: false
Prepared: false
Classes:
  - Bard
