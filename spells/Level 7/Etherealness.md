...
Range: Self
Components: "V, S"
Concentration: No (Up to 8 hours)
Ritual: false
Damage: null
"Damage Type": null
Upgrade: Using a Higher-Level Spell Slot. You can target up to three willing creatures (including yourself) for each spell slot level above 7. The creatures must be within 10 feet of you when you cast the spell.
Spell Book: false
Prepared: false
Classes:
  - Bard
